# app.py - COMPLETE WORKING VERSION WITH USER MANAGEMENT
...
class UserManager:
    ...
    def change_user_password(self, username, new_password, changed_by="admin"):
        ...
        # Update analytics
        if 'password_resets' not in self.analytics:
            self.analytics['password_resets'] = []
        
        self.analytics['password_resets'].append({
            "username": username,
            "timestamp": datetime.now().isoformat(),
            "changed_by": changed_by
        })
